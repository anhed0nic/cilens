...
```bash
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/dsalaza4/cilens/releases/download/v0.5.0/cilens-installer.sh | sh
```
...
```bash
nix profile install github:dsalaza4/cilens/v0.5.0
```

Or run without installing:

```bash
nix run github:dsalaza4/cilens/v0.5.0 -- --help
```
